    ...
    def _get_moves_raw_values(self):
        ...
        for record in result:
            ...
            if mrp_bom_line_obj and not mrp_bom_line_obj.is_supplementary_product:
                product_qty = self.product_qty * mrp_bom_line_obj.product_qty
                loss_percent_qty = (product_qty * mrp_bom_line_obj.loss_percent) / 100
                product_uom_qty = product_qty + loss_percent_qty
                record.update({"product_uom_qty":product_uom_qty})
        return result
        ...
        if finished_move:
            ...
            for line in self.mrp_bom_overhead_ids:
                ...
                if line.overhead_parameters == "percent":
                    total_cost_overheads += (line.overhead_cost * total_cost)/ 100
