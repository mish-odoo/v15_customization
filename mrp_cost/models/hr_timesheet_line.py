...
class HrTimesheetLine(models.Model):
    ...
    total_time = fields.Float("Total Work Time", compute="_compute_total_timesheet_cost", default=0.0)
    work_cost = fields.Monetary('Cost', related="employee_id.timesheet_cost")
